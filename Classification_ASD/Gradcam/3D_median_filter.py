...
if __name__ == '__main__':
    ...
    parser.add_argument('--remove_islands_label', type=int, help='Remove this specific label', default=None)
    ...
    if(args.remove_islands):
        if (args.remove_islands_label is not None):
            RemoveIslands(surf, labels, args.remove_islands_label, args.min_count)
        else:
